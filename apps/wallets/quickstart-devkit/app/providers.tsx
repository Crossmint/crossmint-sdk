...
const ALIAS_CONFIG = process.env.NEXT_PUBLIC_WALLET_ALIAS
    ? {
...
function QueryParamsProvider({ children }: { children: React.ReactNode }) {
    ...
    const signerType = searchParams.get("signer") || "api-key";
    ...
    if (chainType === "evm") {
        ...
        return (
            <StellarCrossmintAuthProvider apiKey={crossmintApiKey} createOnLogin={createOnLogin}>
                {children}
