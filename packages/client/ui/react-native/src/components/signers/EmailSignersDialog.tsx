                        ...
                        {step === "initial" ? (
                            <>
                                ...
                                <Text style={dynamicStyles.description}>
                                    You're using this wallet for the first time on this device. Click 'Send code' to get
                            ...
                            <>
                                ...
                                <Text style={dynamicStyles.otpTitle}>Check your email</Text>
