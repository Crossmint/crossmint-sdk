 ...
 * never reaches this component, the developer's JavaScript, or the agent. The buyer JWT comes
 * from the Crossmint context (`CrossmintAuthProvider` or `useCrossmint().setJwt`).
 */
