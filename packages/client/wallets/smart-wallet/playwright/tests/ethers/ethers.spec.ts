...
test.describe("AA wallet", () => {
    ...
    test("should allow me to sign a message", async ({ page }) => {
        ...
        await expect(locatorSign).toHaveValue(
            "0x7e3bf41cade8bb138beb7a04930d14eaa6f2b41b76dcc36ea994bb907c86c85f24680a3860b44299615b38437413830a54c8bad9ec51f192086e8fea0d0167a21c",
            { timeout: 20_000 }
        );
    });
