...
test.describe("AA wallet with Fireblocks signer", () => {
    ...
    test("should allow me to check localStorage and purge", async ({ page }) => {
        ...
        await expect(locatorLocalStorageText).toHaveText('Data found in LocalStorage starting with "NCW-".', {
            timeout: 5_000,
        });
        ...
        await expect(locatorLocalStorageTextAfterPurge1).toHaveText(
            'No data found in LocalStorage starting with "NCW-".',
            { timeout: 5_000 }
        );

        await createFireblocksWallet(page);
        await page.getByTestId("CheckLocalStorageBtn").click();
        ...
        await expect(locatorLocalStorageTextAfterPurge).toHaveText(
            'No data found in LocalStorage starting with "NCW-".',
            { timeout: 5_000 }
        );
    });
...
test.describe("AA wallet with Fireblocks signer", () => {
    test("should allow me to sign and verify a message ", async ({ page }) => {
        ...
        const signedMessage =
            "";
