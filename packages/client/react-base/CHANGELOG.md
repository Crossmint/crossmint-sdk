...
- 02ac7bc: Replace console.error with structured logger.error in CrossmintWalletBaseProvider for improved observability
...
- 4dc0dbf: Add JSDoc comments to provider props, wallet context, and auth types
